...
//  Mybx
//
//  Created by Tsz Yeung Lam on 2018-04-08.
...
final class ProfileVC: UICollectionViewController {
    ...
    init(viewModel: PhotosViewModelType, cat: BXCategory, isProfile: Bool = false) {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let fm = UserDefaultManager()
        let items = fm.loadInstaItems(forCategory: category)
        _viewModel = PhotosViewModel(instaItems: items, favManager: fm)
...
extension ProfileVC : CHTCollectionViewDelegateWaterfallLayout {
...
extension ProfileVC: PhotoSliderDelegate {
